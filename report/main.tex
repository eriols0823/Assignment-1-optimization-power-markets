...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{lXX}
    ...
    (equation syntax, macros, nomenclature) for formulas the group wrote itself; merging the
    group members' LaTeX drafts into one report with a consistent structure and notation;
    explaining the assignment brief/rubric and course concepts on request; brainstorming what
    a formulation should cover. Not used for: formulating, deriving or solving any graded
    question.
    &
