...
\todo{Step 4: in load regime 2, the value of ${\pvprod}^*$ and of ${\qimp}^*$ (from the
balance) on each side of the threshold $\pimp$, and the interpretation in words: what the
consumer compares in each regime and why curtailment only happens there. Partial curtailment
requires $\cpv = \pimp$, which is a tie, treated in (v).}
